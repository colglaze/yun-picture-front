...
/** 编辑空间 DELETE /api/space/edit */
export async function editSpaceUsingDelete(
...
/** 获取所有空间级别 GET /api/space/list/level */
...
/** 分页查询空间 POST /api/space/list/page */
